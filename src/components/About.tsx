  ...
  return (
    ...
    >
      ...
      `}>
        ...
        <motion.div
          className={`
            flex w-full flex-col justify-center text-white
            xl:w-[55%]
          `}
        ...
        >
          ...
          <motion.p
            className={`
              mt-5 w-fit rounded-full border border-sky-300/30 bg-sky-300/10
              px-4 py-1 text-xs font-semibold tracking-[0.2em] text-sky-200
              uppercase
              sm:text-sm
            `}
            variants={fadeUpItem}
          ...
          <motion.p
            className={`
              mt-5 text-base leading-relaxed text-slate-100/90
              sm:text-lg
            `}
            variants={fadeUpItem}
          >
          ...
          <motion.p
            className={`
              mt-4 text-base leading-relaxed text-slate-100/80
              sm:text-lg
            `}
            variants={fadeUpItem}
          >
