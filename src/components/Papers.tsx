...
export const Papers: FC = () => {
  return (
    ...
    >
      ...
      <div className={`
        relative mx-auto h-[600px] w-full max-w-[1320px] overflow-hidden
        rounded-lg px-2
      `}>
        <motion.img
          className={`
            hidden h-[600px] w-full rounded-lg object-cover
            sm:flex
          `}
          src={cloudComputing}
          alt="Cloud Computing"
        ...
        />
        <div className={`
          absolute top-0 left-0 flex h-full w-full items-center px-4
          sm:ml-4
        `}>
          <motion.div
            className={`
              card mx-auto w-96 rounded-lg glass shadow-lg
              sm:mx-0
            `}
            variants={fadeUpItem}
